...
import { Skull, Shield, Users, User, Play, RotateCcw, Target, ChevronRight, Trophy, Gamepad2 } from 'lucide-react';
...
export default function MultiplayerBattlePage() {
  ...
  useEffect(() => {
    ...
    const ws = createMultiplayerWsConnection({
      ...
      onPlayerLeave: (leavePlayerId) => {
        console.log('玩家离开:', leavePlayerId);
      },
      onTurnStart: (payload) => {
        console.log('回合开始:', payload);
      },
      onTurnEnd: (payload) => {
        console.log('回合结束:', payload);
      },
      onGameEnd: (payload) => {
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="p-4">
          ...
          <div className="flex justify-center items-end gap-[-24px] flex-wrap pb-4">
            {zhongLvCards.slice(0, 5).map((card, index) => {
