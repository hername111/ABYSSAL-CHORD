...
export const enemies: Enemy[] = [
  {
    ...
    actions: [
      ...
      { diceRange: [4, 4], name: '声波蓄积', nameEn: 'Wave Accumulation', type: 'buff', effect: '获得 8 点护甲，并使污染刻度尺 +1。', armor: 8, pollutionIncrease: 1 },
  ...
  },
  {
    ...
    actions: [
      ...
      { diceRange: [6, 6], name: '绝对寂静', nameEn: 'Absolute Silence', type: 'aoe', effect: '使污染刻度尺 +2。对所有玩家施加"失聪"Debuff（本回合攻击牌伤害-2），持续1回合。', pollutionIncrease: 2, special: 'deafen_all' },
    ],
  },
  {
    id: 'mutos',
    ...
    phase2Effect: '清空所有玩家护甲；污染刻度尺 +5；穆托斯获得"咏叹调"状态（永久：每回合获得8护甲、每回合结束时污染度+2、伤害类行为+5）',
    actions: [
      ...
      { diceRange: [5, 5], name: '深渊呼唤', nameEn: 'Abyssal Call', type: 'special', effect: '使污染刻度尺 +2。召唤 1 只嘶鸣游荡者（生命值为标准值的50%）。', pollutionIncrease: 2, special: 'summon_drifter_half' },
    ...
    phase2Actions: [
      ...
      { diceRange: [5, 5], name: '深渊再呼', nameEn: 'Abyssal Recall', type: 'special', effect: '使污染刻度尺 +3（2+1额外）。召唤 1 只嘶鸣游荡者（标准值75%生命）。', pollutionIncrease: 3, special: 'summon_drifter_75' },
